 ...
 *
 * Disassembly of ssdt10.dat, Sat Jul 17 20:30:46 2021
 *
...
DefinitionBlock ("", "SSDT", 2, "DELL  ", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            OperationRegion (TNVS, SystemMemory, 0x62CD7000, 0x2F)
            ...
            Name (RES0, ResourceTemplate ()
            {
                ...
                Interrupt (ResourceConsumer, Level, ActiveLow, Shared, ,, _Y57)
                {
                    0x0000000C,
                }
            })
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Else
                {
                    CreateDWordField (RES0, \_SB.TPM._Y57._INT, LIRQ)  // _INT: Interrupts
            ...
            Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
            {
                If ((IRQN != Zero))
                {
                    ...
                    CreateBitField (RES0, \_SB.TPM._Y57._HE, LTRG)  // _HE_: High-Edge
                    LTRG = ITRG /* \_SB_.TPM_._SRS.ITRG */
                    CreateBitField (Arg0, 0x7A, ILVL)
                    CreateBitField (RES0, \_SB.TPM._Y57._LL, LLVL)  // _LL_: Low Level
